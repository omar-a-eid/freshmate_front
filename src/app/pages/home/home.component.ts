...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [HeroSectionComponent, OffersSectionComponent, BenefitsSectionComponent, PremiumSectionComponent, CollectionSectionComponent, FeedbackSectionComponent, LogosSectionComponent, BestSellerComponent],
